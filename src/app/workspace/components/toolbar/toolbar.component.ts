...
export class ToolbarComponent implements OnInit {
  ...
  protected readonly modeControl = new FormControl(Command.SELECT, {
    nonNullable: true,
  });
  protected readonly isAnythingSelected$ =
    this.workspaceState.isAnythingSelected$;
  protected readonly delete$: Subject<void> = new Subject();

  public ngOnInit(): void {
    this.workspaceState.mainCommand$.subscribe(command =>
      this.modeControl.patchValue(command)
    );
